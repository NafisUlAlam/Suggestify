const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Suggestify.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Suggestify, accessible from{" "}
            <a
              href="https://nafis-suggestify.netlify.app/"
      ...
      <ul>
        <li>By email: info@suggestify.com</li>
      </ul>
    </div>
  );
};
