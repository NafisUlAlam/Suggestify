    ...
    <section className="py-6 lg:py-12 bg-[#f4f4f4] mt-12 bg-banner4 bg-no-repeat bg-center bg-cover">
      ...
      <Marquee pauseOnHover speed={100}>
        {reviews.map((review) => (
          <div
            key={review._id}
            className="flex flex-col items-center justify-center space-y-4 text-center p-4  lg:space-y-0 bg-transparent lg:gap-4 max-w-2xl min-h-[500px] mr-8 text-gray-200"
          >
            ...
            <h1 className="text-lg font-extrabold ">{review.title}</h1>
